...
IF NOT EXIST "%USERPROFILE%\mystic" (
    ...
    git clone https://chat.whatsapp.com/HhZUtxp2KRTD5rD5j09VCy.git "%USERPROFILE%\mystic"
...
git pull https://chat.whatsapp.com/HhZUtxp2KRTD5rD5j09VCy.git > git_output.txt
