...
const handler = async (m, { conn, args, usedPrefix }) => {
   ...
   const res = await fetch('https://api.github.com/repos/BrunoSobrino/ 𝙔𝙪𝙢𝙢𝙮 𝘽𝙤𝙩');
   ...
   txt += `${tradutor.texto1[11]}\n_${usedPrefix}gitclone ${json?.html_url || 'https://chat.whatsapp.com/HhZUtxp2KRTD5rD5j09VCy'}_`;
