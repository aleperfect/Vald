/**
 𝙔𝙪𝙢𝙢𝙮 𝘽𝙤𝙩@BrunoSobrino - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '56971943258 -1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': ' 𝙔𝙪𝙢𝙢𝙮 𝘽𝙤𝙩', 'jpegThumbnail': null } } };
